...
## Footer
footer-foreword = ONVotes by Kaitlyn Kenwell
footer-next = Content extracted from the
footer-assembly = Ontario Legislative Assembly

## Home page
main-subtitle = This website holds records of all votes recorded in Ontario's Legislative Assembly's 42nd session in an accessible fashion.
...
main-temp-adjourned = The House is adjourned
main-temp-adjourned-subtitle = The Ontario Parliament is adjourned until February 16, 2021.
